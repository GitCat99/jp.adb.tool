...
TITLE Sharp 506sh 8.0 adb批量操作工具v1.0--by 翻车猫
color 8f
:STARTMENU
ECHO. =======================================================
...
CALL %adb% uninstall jp.co.yahoo.android.weather.keyguardwidget
CALL %adb% uninstall jp.co.yahoo.android.yfinkeyguardwidget
ECHO.
...
CALL %adb% shell pm uninstall -k --user 0 com.google.android.gm.ConversationListActivityGmail
CALL %adb% shell pm uninstall -k --user 0 com.google.android.launcher.StubApp
...
CALL %adb% shell pm uninstall -k --user 0 com.google.android.youtube.app.honeycomb.Shell$HomeActivity
CALL %adb% shell pm uninstall -k --user 0 jp.co.softbank.mb.pim.activity.SplashScreenActivity
